# 4lock-core Cursor documentation

Docs in this folder are the source of truth for architecture and development. Always consult them before making changes (see `.cursor/rules/00-context-inclusion.mdc`).
